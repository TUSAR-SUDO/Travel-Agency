...
/**
 * Mid-page WhatsApp conversion band.
 * @param {{ message?: string, title?: string, sub?: string }} props
 */
export default function WhatsAppCTA({
  message,
  title = 'Ready when you are.',
  sub = 'One message on WhatsApp and our trip designers take it from there — itinerary, prices, dates.',
}) {
  return (
    <Reveal>
      <div className="relative overflow-hidden rounded-3xl bg-navy px-8 py-12 text-center sm:px-14">
        <div
        ...
        <p className="relative mt-4 text-xs text-white/50">
          Prefer talking? Call {SITE.phone} — {SITE.hours}
        </p>
      </div>
    </Reveal>
  )
